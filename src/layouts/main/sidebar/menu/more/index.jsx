...
export default function More() {
    return (
        <Popover className="relative">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-menuBox shadow-white rounded-xl overflow-hidden">
                ...
                <div className="flex items-center justify-center ">
                    <hr className="h-[1px] w-[283px] flex bg-[#2f3336] my-0.5" />
                </div>
                ...
                <Disclosure>
                    <Disclosure.Button className="h-[52px] flex items-center px-4 font-bold justify-between w-full hover:bg-[#eff3f41a] transition-colors">
                        ...
                        <svg viewBox="0 0 24 24" fill="#e7e9ea" width={18.75} height={18.75}>
                            <path d="M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z" />
                        </svg>
                    </Disclosure.Button>
                    <Disclosure.Panel className="text-gray-500">
                        <button className="px-3 h-11 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                            <div className="w-[18.75px] h-[18.75px] ml-3">
                                <svg viewBox="0 0 24 24" fill="#e7e9ea">
                                    <path d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z" />
                                </svg>
                            </div>
                            <div className="pr-3 font-bold text-sm text-[#e7e9ea]">
                                İstatistikler
                            </div>
                        </button>
                    </Disclosure.Panel>
                ...
                <Disclosure>
                    ...
                    <Disclosure.Panel className="text-gray-500">
                        ...
                        <button className="px-3 h-11 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                            ...
                            <Link to="/" className="pr-3 font-bold text-sm text-[#e7e9ea]">
                                Klavye kısayolları
                            </Link>
                        </button>
                    </Disclosure.Panel>
