export const mainMenu = [
        ...
        icon: {
            active: (
                <svg fill="#fff" viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path d="M12 1.696L0.622 8.807l1.06 1.696L3 9.679V19.5C3 20.881 4.119 22 5.5 22h13c1.381 0 2.5-1.119 2.5-2.5V9.679l1.318.824 1.06-1.696L12 1.696zM12 16.5c-1.933 0-3.5-1.567-3.5-3.5s1.567-3.5 3.5-3.5 3.5 1.567 3.5 3.5-1.567 3.5-3.5 3.5z" />
                </svg>
            ),
            passive: (
                <svg fill="#fff" viewBox="0 0 24 24" width={26.25} height={26.25}>
    ...
    },
    {
        ...
        icon: {
            ...
            passive: (
                <svg fill="#fff" viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path d="M11.996 2c-4.062 0-7.49 3.021-7.999 7.051L2.866 18H7.1c.463 2.282 2.481 4 4.9 4s4.437-1.718 4.9-4h4.236l-1.143-8.958zM12 20c-1.306 0-2.417-.835-2.829-2h5.658c-.412 1.165-1.523 2-2.829 2zm-6.866-4l.847-6.698C6.364 6.272 8.941 4 11.996 4s5.627 2.268 6.013 5.295L18.864 16H5.134z" />
                </svg>
            )
        }
    },
